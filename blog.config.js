...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '9651225e1aeb40a19eb85ceed2b081f0',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '离开乏味的皮囊, 自由的灵魂在路上, 欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Alan_Hsu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '离开乏味的皮囊，自由的灵魂在路上', // 作者简介
